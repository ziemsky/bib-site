...
[NOTE]
Wklejona ramka automatycznie dodaje nową warstwę o nazwie "_ramki_". Warstwy tej nie usuwaj, bo stracisz ramki z tego i pozostałych stron w bieżącym pliku rysunku.
