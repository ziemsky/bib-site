...
Na dysku Twojgo komputera (np. w katalogu "_Dokumenty_" albo tam gdzie trzymasz swoje projekty) stwórz strukturę katalogów:
...
W czasie uruchamiania, QCAD automatycznie tworzy pusty rysunek. Jeśli tak właśnie się stało, zamknij ten rysunek (bez zamykania samego programu):
* `_File > Close_`
* wybierz "_Close without Saving_".
...
* umieszczać je na xref:#niedrukowalna-warstwa[niedrukowalnej warstwie] "_wymiary opisy (model)_",
